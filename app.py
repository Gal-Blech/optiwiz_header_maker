# -*- coding: utf-8 -*-
"""Optiwiz Header Maker - Web App

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/19Cor1PrCrMw9za6p27vIvaaXagjGOUd1
"""
...
def format_color_hex(argb_hex):
    ...
    if argb_hex and len(argb_hex) == 8:
        return f"#{argb_hex[2:]}"
    return None
...
def generate_yaml_from_file(file_object):
    ...
    for row in sheet.iter_rows():
        ...
        for cell in row:
            ...
            if cell.font.name.lower() != 'calibri': cell_obj['font_name'] = cell.font.name.lower()
            if cell.font.size != 11: cell_obj['font_size'] = int(cell.font.size)
            ...
            if cell.fill.fill_type == 'solid' and cell.fill.start_color.rgb:
